...
assert.match(html, /const measurePayloadEncoding = analysisPayloadEncodingInput\.checked/);
assert.match(html, /JSON\.stringify\(\{ requireManifest, measurePayloadEncoding \}\)/);
